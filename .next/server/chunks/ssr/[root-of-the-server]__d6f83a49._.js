...
;
;
const authenticationThunk = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("authentication", async (_, thunkAPI)=>{
    try {
...
async function stopProductActive(id, acive) {
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$config$2f$fetch$2d$api$2e$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiAction"].patch(`seller/products/${id}/${acive}`);
        const result = res.data;
        return result;
    } catch (error) {
        return {
