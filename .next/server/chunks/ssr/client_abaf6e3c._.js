...
function PageWrapper({ role, children }) {
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const managerPageActive = async ()=>{
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$redux$2f$app$2f$slice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onLoadingAction"])(true));
            const checkAuth = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$redux$2f$auth$2f$thunk$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticationThunk"])(`${role}`));
            if (checkAuth) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$redux$2f$app$2f$slice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onLoadingAction"])(false)); //loading animation
                try {
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$client$2f$redux$2f$auth$2f$thunk$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticationThunk"].fulfilled.match(checkAuth) && checkAuth.payload) {
                        if (role === "seller" && checkAuth.payload.role === "user") {
                            router.replace("/user");
                        } else {
                            router.replace(`/${role}`);
                        }
                    } else if (__TURBOPACK__imported__module__$5b$project$5d2f$client$2f$redux$2f$auth$2f$thunk$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticationThunk"].rejected.match(checkAuth)) {
