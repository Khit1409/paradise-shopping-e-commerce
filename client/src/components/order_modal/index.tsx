...
import OrderSelectAddress from "./form/OrderSelectAddress";
import OrderAttributePreview from "./form/OrderAttributePreview";
import OrderProductInfo from "./form/OrderProductInfo";
import OrderSelectShippingMethod from "./form/OrderSelectShippingMethod";
import OrderSelectPaymentMethod from "./form/OrderSelectPaymentMethod";
import OrderSelectEmail from "./form/OrderSelectEmail";
import OrderSelectPhone from "./form/OrderSelectPhone";
/**
 * function component
 * @returns
 */
